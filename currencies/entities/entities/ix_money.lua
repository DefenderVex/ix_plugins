...
function ENT:SetupDataTables()
	...
	self:NetworkVar("String", 1, "Currency")
end
...
if (SERVER) then
	...
	function ENT:Initialize()
		self:SetModel(ix.currencies.GetValue(self:GetCurrency(), "model"))
	...
	function ENT:OnPopulateEntityInfo(container)
		...
		text:SetImportant()
		text:SetText(ix.currency.Get(self:GetAmount(), self:GetCurrency()))
		text:SizeToContents()
	end
end
